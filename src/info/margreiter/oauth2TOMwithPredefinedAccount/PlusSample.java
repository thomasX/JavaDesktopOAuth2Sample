package info.margreiter.oauth2TOMwithPredefinedAccount;
...
public class PlusSample {
   ...
   */
  private static final String APPLICATION_NAME = "FERPS-CLIENT";
  ...
  public static void main(String[] args) {
    try {
      ...
      // run commands
      System.out.println("PlusSample.main() getProfile");
      getProfile();
      System.out.println("PlusSample.main() listactivites ");
      listActivities();
      System.out.println("PlusSample.main() getactivity");
      getActivity();
      // success!
      return;
    } catch (IOException e) {
